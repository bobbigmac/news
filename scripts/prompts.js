...
3. For each cluster, write a SHORT factual headline — no more than 8 words. No clickbait, no sensationalism, no question marks. State what happened, not what might happen.
4. Write a SUMMARY of 30-60 words in block text. Cover the key facts: what happened, who is involved, why it matters. Do NOT repeat the headline. Do NOT list every detail — distil. If this is a development of an existing story, focus on what is new.
